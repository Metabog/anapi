...
class MapController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UnifiedMainBundle:Map')->findAll();
     ...
     * @Method("POST")
     * @Template("UnifiedMainBundle:Map:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UnifiedMainBundle:Map')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UnifiedMainBundle:Map:edit.html.twig")
     */
